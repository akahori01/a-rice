    ...
    <div class="menu-content">
        <ul class="ddmenu">
            ...
            <ul class="setttings-pulldown">
                ...
                <li><button class="link-style" type="submit" name="logout" value="<?= $logoutNum ?>"><img src="/library/logout.png" alt="ログアウト">ログアウト</button></li>
                </form>
            </ul>
            </li>
    ...
    <div class="menu-content">
        <ul class="ddmenu">
            ...
            <ul class="setttings-pulldown">
                ...
                ?>
                <form action="" method="post">
                <li><button class="link-style" type="submit" name="logout" value="<?= $logoutNum ?>"><img src="../public/library/logout.png" alt="ログアウト">ログアウト</button></li>
                </form>
            </ul>
            </li>
