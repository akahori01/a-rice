...
class OrderModel{
    ...
    // private function adminUnsetOrder($resetOrderId, $resetWeek)
    // {
    //     switch ($resetWeek){
    //         case 'before':
    //             foreach ($this->getBeforeDay() as $key => $object){
    ...
    //             break;
    //         case 'today':
    //             foreach ($this->getToday() as $key => $object){
    //                 switch ($object->getOrderId()){
    //                     case $resetOrderId:
    ...
    //             break;
    //         case 'after':
    //             foreach ($this->getAfterDay() as $key => $object){
    //                 switch ($object->getOrderId()){
    //                     case $resetOrderId:
    ...
    // public function adminOrderDelete($resetOrderId, $resetWeek)
    // {
    //     switch ($resetWeek){
    //         case 'before':
    //             $orderIds = $this->orderIds($this->getBeforeDay());
    //             if (in_array($resetOrderId, $orderIds, true)){
    //                 $this->deleteOrderRecord($resetOrderId);
    //                 $this->adminUnsetOrder($resetOrderId, $resetWeek);
